...
/**
 * 不同{@link RedisDistributeLockProperties.RedissonMode}下{@link Config}的创建
 *
...
public class RedissonConfigFactory {
    ...
    public static Config createRedissonConfig(RedisDistributeLockProperties properties) {
     ...
     * @return redisson配置
     */
    public static Config createSingleRedissonConfig(RedisDistributeLockProperties properties) {
     ...
     * @return redisson配置
     */
    public static Config createSentinelRedissonConfig(RedisDistributeLockProperties properties) {
     ...
     * @return redisson配置
     */
    public static Config createClusterRedissonConfig(RedisDistributeLockProperties properties) {
        Config config = new Config();
     ...
     * @return redisson配置
     */
    public static Config createMasterSlaveRedissonConfig(RedisDistributeLockProperties properties) {
        Config config = new Config();
    ...
    private static <T extends BaseConfig<T>> void setRedissonConfig(BaseConfig<T> baseConfig, RedisDistributeLockProperties properties) {
